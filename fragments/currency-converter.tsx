...
export default function CurrencyConverter({
  ...
  function onAmountChange(event: StandardTextFieldProps) {
    if (data === null) return;
    changeCurrency(0, false)
  }

  function onConvertedAmountChange(event: StandardTextFieldProps) {
    if (data === null) return;
    changeCurrency(0, false)
  }
    ...
    <Card>
      ...
      <div>
        ...
        <Select defaultValue="PLN" onChange={onToChange}>
          ...
          <TextField defaultValue={0} type='number' onChange={onConvertedAmountChange} />
        </div>
      </div>
    </Card>
  );
